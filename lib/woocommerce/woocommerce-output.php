...
add_filter( 'woocommerce_enqueue_styles', 'abstract_woocommerce_styles' );
/**
 ...
 */
function abstract_woocommerce_styles( $enqueue_styles ) {
...
add_action( 'wp_enqueue_scripts', 'abstract_woocommerce_css' );
/**
 ...
 */
function abstract_woocommerce_css() {
	...
	$color_link   = get_theme_mod( 'abstract_link_color', $appearance['default-colors']['link'] );
	$color_accent = get_theme_mod( 'abstract_accent_color', $appearance['default-colors']['accent'] );
	...
	',
		$color_accent,
		abstract_color_contrast( $color_accent )
	) : '';
