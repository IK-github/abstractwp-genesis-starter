...
add_action( 'wp_enqueue_scripts', 'abstract_custom_gutenberg_css' );
/**
 * Outputs front-end inline styles based on colors declared in config/appearance.php.
 *
 * @since 2.9.0
 */
function abstract_custom_gutenberg_css() {
...
CSS;
	...
	$css .= abstract_inline_font_sizes();
	$css .= abstract_inline_color_palette();

	wp_add_inline_style( genesis_get_theme_handle() . '-gutenberg', $css );

}

add_action( 'enqueue_block_editor_assets', 'abstract_custom_gutenberg_admin_css' );
/**
 ...
 * @since 2.9.0
 */
function abstract_custom_gutenberg_admin_css() {
 ...
 */
function abstract_inline_font_sizes() {
 ...
 */
function abstract_inline_color_palette() {
