 ...
 * @since 2.7.0
 */
function abstract_enqueue_gutenberg_frontend_styles() {
...
add_action( 'enqueue_block_editor_assets', 'abstract_block_editor_styles' );
/**
 * Enqueues Gutenberg admin editor fonts and styles.
 *
 * @since 2.7.0
 */
function abstract_block_editor_styles() {
...
add_filter( 'body_class', 'abstract_blocks_body_classes' );
/**
 ...
 */
function abstract_blocks_body_classes( $classes ) {
...
$abstract_appearance = genesis_get_config( 'appearance' );

// Adds support for editor font sizes.
add_theme_support(
	'editor-font-sizes',
	$abstract_appearance['editor-font-sizes']
);

// Adds support for editor color palette.
add_theme_support(
	'editor-color-palette',
	$abstract_appearance['editor-color-palette']
);
...
function abstract_content_width() {
	...
	$GLOBALS['content_width'] = apply_filters( 'abstract_content_width', $appearance['content-width'] );
